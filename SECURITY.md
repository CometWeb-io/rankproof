...
**Do not open a public issue** for a security flaw. Email `hello@cometweb.io` or use GitHub's private vulnerability reporting (*Security* tab → *Report a vulnerability*).
